...
import com.example.power.mobile_health.UI.Adapter.DragRecyclerViewAdapter;
...
public class SwipeRecyclerView extends RecyclerView {
    ...
    private ConstraintLayout mLlHidden;//隐藏部分
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if (item != null) {
                    //获取当前选中的Item
                    DragRecyclerViewAdapter.MyViewHolder viewHolder = (DragRecyclerViewAdapter.MyViewHolder) getChildViewHolder(item);
                    mCurItemLayout = viewHolder.ll_item;
                    //找到具体元素（这与实际业务相关了~~）
                    mLlHidden = (ConstraintLayout)mCurItemLayout.findViewById(R.id.privatedoctor_recyclerview_messageItem_rightLayout);
                    mItemDelete = (ConstraintLayout)mCurItemLayout.findViewById(R.id.privatedoctor_recyclerview_messageItem_rightLayout);
